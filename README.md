...
int main(void)
{
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
    ...
    Lcd_cursor(&lcd, 0,0);
    Lcd_string(&lcd, "shakthivel");

    Lcd_cursor(&lcd,1,0);
        Lcd_string(&lcd, "212224240149");
        HAL_Delay(500);
  while (1)
  {
...
![WhatsApp Image 2025-09-17 at 09 35 39_8d9a5f2f](https://github.com/user-attachments/assets/d8e364be-ded7-4e05-9256-898ecce6ae93)
